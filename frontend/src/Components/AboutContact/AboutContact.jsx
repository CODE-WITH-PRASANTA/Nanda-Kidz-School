        ...
        <div className="about-contact-grid">
          ...
          <div className="about-contact-info">
            ...
            <div className="about-contact-photo-wrapper">
              <div className="about-contact-campus-card">
                <div className="about-contact-campus-badge">
                  <Sparkles size={16} /> Nanda Kidz Campus
                </div>
                <div className="about-contact-campus-graphic">
                  <Building2 size={54} className="campus-main-icon" />
                  <div className="campus-mini-icons">
                    <span className="mini-icon-pill">🎈 Play Zone</span>
                    <span className="mini-icon-pill">🎨 Smart Class</span>
                  </div>
                </div>
                <div className="about-contact-campus-footer">
                  <GraduationCap size={18} /> Shaping Future Leaders
                </div>
              </div>

              <div className="about-contact-help-badge">
                <Headphones size={20} className="about-contact-help-icon" />
                <span>
                  We're here
                  <br />
                  to help!
