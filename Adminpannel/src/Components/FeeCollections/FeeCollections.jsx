  ...
  return (
    <div className="fee-collections-dashboard-container">
      ...
      <header className="fee-collections-header">
        ...
        <div className="fee-collections-header-actions">
          <button className="fee-collections-icon-btn fee-collections-notification-btn" aria-label="Notifications">
            <span className="fee-collections-notification-badge">5</span>
            <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
          </button>
          <div className="fee-collections-user-profile">
            <img src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=100&h=100&fit=crop&crop=faces" alt="Admin User" className="fee-collections-user-avatar" />
            <span className="fee-collections-user-name">Admin User</span>
